...
root_dir = '../media/employees/'
model_weights = 'model.h5'

# Initialize the FaceDetector
face_detector = FaceDetector(root_dir, model_weights)

# Add camera streams (replace with your actual camera URLs/IP)
camera_urls = ['http://192.168.1.169:5000/video']
face_detector.add_camera(camera_urls)

# Start processing the video streams
face_detector.start_all_video_captures()
